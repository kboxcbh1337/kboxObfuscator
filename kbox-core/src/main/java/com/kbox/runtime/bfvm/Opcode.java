...
/**
 * Runtime mirror of {@code com.kbox.core.bfvm.compile.Opcode}. MUST stay byte-identical
 * with the build-side constants: the compiler emits these values into the stream and
 * {@link VmCore} dispatches on them. The runtime ships self-contained inside protected
 * jars, so it carries its own copy rather than depending on build-side classes.
 */
public final class Opcode {
    ...
    // ---- ops whose numeric value matches the JVM opcode ----
